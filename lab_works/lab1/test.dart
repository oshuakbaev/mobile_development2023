class Human{
    ...
    Human({String? this.name, int? this.age, int? this.weight,int? this.height,int? this.day_of_birth , 
    int? this.month_of_birth,int? this.year_of_birth,String? this.address}); 
}

class Collegue extends Human{
    int? salary,date_connection, work_exp; 

    Collegue({String? name, int? age, int? weight, int? height, int? day_of_birth, int? month_of_birth, int? year_of_birth, 
    String? address, int? this.salary, int? this.date_connection,int? this.work_exp}) : super(name: name, age: age, weight: weight, height: height, 
    day_of_birth: day_of_birth, month_of_birth: month_of_birth, year_of_birth: year_of_birth, address: address);
}
...
class Student extends Human{
    ...
    Student(String? name, int? age, int? weight, int? height, int? day_of_birth, int? month_of_birth, int? year_of_birth, String? address,
     List<int>? list_points, List<String>? list_subj):super(name: name, age: age, weight: weight, height: height, 
    day_of_birth: day_of_birth, month_of_birth: month_of_birth, year_of_birth: year_of_birth, address: address);
}


void main(){
    Human Bakda = new Human(name: "Bakda", age: 55, weight: 80, height: 184, day_of_birth: 18, month_of_birth: 5, year_of_birth: 1984, address: "Pushkina7");

    print("Name: ${Bakda.name}");
    print("Age: " +Bakda.age.toString());
    print("Weight: "+Bakda.weight.toString());
    print("Height:" + Bakda.height.toString());
    print("birthday: ${Bakda.day_of_birth}-${Bakda.month_of_birth}-${Bakda.year_of_birth}");
    print("Address: ${Bakda.address}\n");


    Collegue Adlet = new Collegue(name: "Adlet", age: 34, weight: 55, height: 155, day_of_birth:31, month_of_birth:2,
                                    year_of_birth:2000,address:"Dafara33",salary:5000,date_connection:55,work_exp:5);
    ...
    print("birthday: ${Adlet.day_of_birth}-${Adlet.month_of_birth}-${Adlet.year_of_birth}");
    ...
    print("birthday: ${Kosnikov.day_of_birth}-${Kosnikov.month_of_birth}-${Kosnikov.year_of_birth}");
